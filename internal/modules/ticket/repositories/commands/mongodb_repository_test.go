...
import (
	...
	mongoRC "order-service/internal/modules/ticket/repositories/commands"
...
func (suite *CommandTestSuite) TestUpsertOneUserTemp() {
	...
	// Act
	result := suite.repository.UpdateOneTicketDetail(suite.ctx, payload)
	// Asset
